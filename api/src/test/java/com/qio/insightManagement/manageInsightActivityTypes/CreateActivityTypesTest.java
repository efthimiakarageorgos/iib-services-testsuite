...
//	}
	...
	@Test
	public void shouldCreateActivityTypeWithUniqueAbbrWithMultiParagraphDesc() throws JsonGenerationException, JsonMappingException,
	...
	@Test
	public void shouldCreateActivityTypeWithUniqueAbbrWhenNameContainsSpecialChars() throws JsonGenerationException, JsonMappingException,
		IOException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		requestActivityType.setActivityName(TestHelper.SPECIAL_CHARS);
		responseActivityType = TestHelper.getResponseObjForCreate(requestActivityType, microservice, environment, apiRequestHelper, activityTypeAPI,
				ActivityType.class);
	...
	@Test
	public void shouldCreateActivityTypeWithUniqueAbbrWhenAbbrContainsDotDashUnderscore() throws JsonGenerationException, JsonMappingException,
		IOException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		String defaultAbbr=requestActivityType.getAbbreviation();
	...
	@Test
	public void shouldCreateActivityTypeWithUniqueAbbrWhenNameIs255CharsLong() throws JsonGenerationException, JsonMappingException,
		IOException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
	
		requestActivityType.setActivityName(TestHelper.TWOFIFTYFIVE_CHARS);
		responseActivityType = TestHelper.getResponseObjForCreate(requestActivityType, microservice, environment, apiRequestHelper, activityTypeAPI,
			ActivityType.class);
	...
	// RREHM-1875
	@Test
	public void shouldCreateActivityTypeWithUniqueAbbrWhenAbbrIs50CharsLong() throws JsonGenerationException, JsonMappingException,
		IOException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		
		String defaultAbbr = requestActivityType.getAbbreviation();
		
		String fiftyChars = TestHelper.FIFTY_CHARS;
